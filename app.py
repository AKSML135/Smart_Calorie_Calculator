...
# load_dotenv()
# #configuring gemini with our api key
...
# #Defining title and other components
# st.title('Smart Calorie Count App 🍕🥦')
...
#     st.image(image,caption="Image Uploaded Thanks..", use_column_width=True)

# submit = st.button("Click Me to know the calories ☞")
# input_prompt = """
